...
-- 문제1 2인 회원에 전화번호를 010-2222-2222 로 수정해주세요
update member
set phone='010-2222-2222'
where id=2;

-- 문제2 id가 5인 회원에 이메일과 주소를 'a@naver.com','부산시 진구'으로 수정해주세요
update member
set email='a@naver.com',address='부산시 진구'
where id=5;

-- 문제3 id=1 회원에 email을 a@naver.com 으로 수정해주세요
update member
set email='a@naver.com'
where id=1;
-- email컬럼에 'a@naver.com' 먼저 들어가 있어서 업데이트 불가
-- unique라 중복을 허용하지 않습니다.